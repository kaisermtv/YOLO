        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                <ul class="footer-nav">
                    ...
                    <li><a href="/tin-tuc/?id=0">Gương mặt</a></li>
                    <li><a href="/tin-tuc/?id=0">Mỗi ngày một câu hỏi</a></li>
                </ul>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                <ul class="footer-nav">
                    <li><a class="footer-no" href="#">Sống</a></li>
                    <li><a href="/tin-tuc/?id=4">Let’s work</a></li>
                    <li><a href="/tin-tuc/?id=3">Sống nơi công sở</a></li>
                </ul>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                <ul class="footer-nav">
                    <li><a class="footer-no" href="#">Cafe công sở</a></li>
                    <li><a href="/tin-tuc/?id=0">Hạt dưa</a></li>
                    <li><a href="/tin-tuc/?id=5">Cafe Lắng</a></li>
                </ul>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                <ul class="footer-nav">
                    <li><a class="footer-no" href="#">Mobifone công sở</a></li>
                    <li><a href="/tin-tuc/?id=0">Mobifone công sở</a></li>
                </ul>
            </div>
        </div>
