...
public partial class System_DanhMucEdit : System.Web.UI.Page
{
    #region declare 
    public int itemId = 0;
    public int group = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (itemId == 0 && group == 0) Response.Redirect("/System/ListCategory.aspx");
        ...
        if (danhuc == null) Response.Redirect("/System/ListCategory.aspx");
