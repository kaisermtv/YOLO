<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Admin.master" CodeFile="GroupAcctList.aspx.cs" Inherits="System_GroupAcctList" %>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Xóa nhóm tài khoản</h4>
                    </div>
                    <div class="modal-body">
                        <p>Bạn xác nhận xóa nhóm tài khoản <b id="ttk"></b></p>
                    </div>
