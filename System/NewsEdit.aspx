...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="AdminItem">
        ...
        <div class="AdminRightItem">
            ...
            <a href="/System/NewsList.aspx<%= (group!=0)?"?Group="+group:"" %>" class="btn btn-default">Thoát</a>

            <a href="/System/NewsEdit.aspx<%= (group!=0)?"?Group="+group:"" %>" style="margin-left:40px" class="btn btn-primary">Thêm mới</a>
        </div>
    </div>
</asp:Content>
