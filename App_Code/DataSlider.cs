...
/// </summary>
public class DataSlider : DataAbstract
{
    ...
    #region method getSlider
    public DataTable getSlider(int type = 0)
    {
        try
        {
            SqlCommand Cmd = this.getSQLConnect();
            Cmd.CommandText = "SELECT ID,TITLE,DESCRIBE,LINK,IMG,NTYPE FROM tblSlider ";
