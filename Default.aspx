<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/App_Master/Site.master" CodeFile="Default.aspx.cs" Inherits="_Default" %>
        ...
        <div class="main">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" id="quangcao">
                    ...
                    <ul class="banner-quangcao">
                        <li>
                            <img src="images/Front-End/quangcao4.png" /></li>
                        <li>
                            <img src="images/Front-End/quangcao2.png" /></li>
                        <li>
                            <img src="images/Front-End/quangcao1.png" /></li>
                        <li>
                            <img src="images/Front-End/quangcao3.png" /></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <ul class="footer-nav">
                        ...
                        <li><a href="#">Mỗi ngày một câu hỏi</a></li>
                    </ul>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <ul class="footer-nav">
                        <li><a class="footer-no" href="#">Sống</a></li>
                        <li><a href="#">Let’s work</a></li>
                        <li><a href="#">Sống nơi công sở</a></li>
                    </ul>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <ul class="footer-nav">
                        <li><a class="footer-no" href="#">Cafe công sở</a></li>
                        <li><a href="#">Hạt dưa</a></li>
                        <li><a href="#">Cafe Lắng</a></li>
                    </ul>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <ul class="footer-nav">
                        <li><a class="footer-no" href="#">Mobifone công sở</a></li>
                        <li><a href="#">Mobifone công sở</a></li>
                    </ul>
                </div>
            </div>
        </div>
